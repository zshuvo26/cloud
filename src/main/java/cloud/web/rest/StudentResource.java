...
public class StudentResource {
    ...
    public ResponseEntity<StudentDTO> createStudent(@Valid @RequestBody StudentDTO studentDTO) throws URISyntaxException {
        ...
        if(studentDTO!=null){
            User user = userService.createCustomUserInformation(studentDTO.getEmail(), "123456", studentDTO.getFirstName(),  studentDTO.getLastName(),  studentDTO.getEmail(), Constants.DEFAULT_LANGUAGE, "ROLE_STUDENT", true);
