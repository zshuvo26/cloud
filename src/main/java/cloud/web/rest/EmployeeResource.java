...
public class EmployeeResource {
    ...
    public ResponseEntity<EmployeeDTO> createEmployee(@Valid @RequestBody EmployeeDTO employeeDTO) throws URISyntaxException {
        ...
        if(employeeDTO!=null){
            User user = userService.createCustomUserInformation(employeeDTO.getEmail(), "123456", employeeDTO.getFirstName(),  employeeDTO.getLastName(),  employeeDTO.getEmail(), Constants.DEFAULT_LANGUAGE, "ROLE_EMPLOYEE", true);
