...
public class CityResourceIntTest {
    ...
    public void createCity() throws Exception {
        ...
        assertThat(testCity.getArea()).isEqualTo(DEFAULT_AREA);
        assertThat(testCity.getStateProvince()).isEqualTo(DEFAULT_STATE_PROVINCE);
    }
    ...
    public void updateCity() throws Exception {
        ...
        assertThat(testCity.getArea()).isEqualTo(UPDATED_AREA);
        assertThat(testCity.getStateProvince()).isEqualTo(UPDATED_STATE_PROVINCE);
    }
